...
# ────────────────────────────────────────────────
#                   БЛОКИРОВКА — ТОЛЬКО ОДНА КОПИЯ
# ────────────────────────────────────────────────

LOCK_FILE = "bot.lock"

if os.path.exists(LOCK_FILE):
    print("Бот уже запущен! Закрой предыдущий экземпляр.")
    sys.exit(1)
...
BOT_TOKEN = "8570594380:AAGDgUcpyZYOSc7xNkcK8KIYrxZGEf0T4Lw"  # ← твой новый токен
